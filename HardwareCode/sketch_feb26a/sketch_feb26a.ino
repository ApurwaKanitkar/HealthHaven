...
#define WIFI_PASSWORD "d4bqav4w"

#define API_KEY "AIzaSyD_6GeDPu1MiHL85Ts7lvCyHvkF5N6PgsE"
#define FIREBASE_PROJECT_ID "health-haven-4c78a"
#define USER_EMAIL "ajinkyabogle@gmail.com"
#define USER_PASSWORD "newuser"
  ...
  //firebase code
    ...
    if (Firebase.ready())
    {
      if(SPO2Valid==1 && heartRateValid==1){
        // condition loops should be added here
